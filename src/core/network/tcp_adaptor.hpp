...
private:
    ...
    typedef std::vector<zmq::socket_t *> socket_vector;
...
public:
    TCP_Adaptor(int sid, std::string fname, int port_base, int nsrvs, int nthds)
    ...
    bool tryrecv(int tid, std::string &str, int &src_sid) {
