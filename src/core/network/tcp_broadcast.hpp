...
public:
    TCP_Broadcast_Master(int sid, int tid, int port_base, std::string fname, int s_tid)
    ...
    bool send(int dst_sid, const std::string &str) {
...
private:
    ...
    inline int port_code(int dst_sid, int dst_tid) { return dst_sid * 200 + dst_tid; }
public:
    TCP_Broadcast_Slave(int sid, int tid, std::string fname, int port_base, int m_sid, int m_tid)
