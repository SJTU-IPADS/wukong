 ...
 * reload config
 */
void reload_config(std::string str)
{
    ...
    Global::mt_threshold = std::max(1, std::min(Global::mt_threshold, Global::num_engines));
...
{
    std::cout << "------ global configurations ------" << LOG_endl;

    // setting by config file
    std::cout << "the number of proxies: "        << Global::num_proxies           << LOG_endl;
    std::cout << "the number of engines: "        << Global::num_engines           << LOG_endl;
    std::cout << "global_input_folder: "          << Global::input_folder          << LOG_endl;
    std::cout << "global_memstore_size_gb: "      << Global::memstore_size_gb      << LOG_endl;
    ...
    std::cout << "global_enable_caching: "        << Global::enable_caching        << LOG_endl;
    std::cout << "global_enable_workstealing: "   << Global::enable_workstealing   << LOG_endl;
    ...
    std::cout << "global_enable_budget: "         << Global::enable_budget         << LOG_endl;
    std::cout << "global_enable_vattr: "          << Global::enable_vattr          << LOG_endl;
    std::cout << "global_num_gpus: "              << Global::num_gpus              << LOG_endl;
    std::cout << "global_gpu_rdma_buf_size_mb: "  << Global::gpu_rdma_buf_size_mb  << LOG_endl;
    std::cout << "global_gpu_rbuf_size_mb: "      << Global::gpu_rbuf_size_mb      << LOG_endl;
    std::cout << "global_gpu_kvcache_size_gb: "   << Global::gpu_kvcache_size_gb   << LOG_endl;
    std::cout << "global_gpu_key_blk_size_mb: "   << Global::gpu_key_blk_size_mb   << LOG_endl;
    std::cout << "global_gpu_value_blk_size_mb: " << Global::gpu_value_blk_size_mb << LOG_endl;
    std::cout << "global_gpu_enable_pipeline: "   << Global::gpu_enable_pipeline   << LOG_endl;
    std::cout << "--" << LOG_endl;

    // compute from other settings
    std::cout << "the number of servers: "        << Global::num_servers           << LOG_endl;
