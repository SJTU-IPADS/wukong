...
public:
    ...
    void create_new_seg(sid_t pid, int num_new_preds) {
        ...
        rdf_seg_meta_map.insert(std::make_pair(segid_t(0, pid, IN), rdf_seg_meta_t()));
        rdf_seg_meta_map.insert(std::make_pair(segid_t(0, pid, OUT), rdf_seg_meta_t()));
    ...
    void init(std::vector<std::vector<triple_t>> &triple_pso,
