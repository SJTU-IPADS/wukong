...
All basic dependencies can be satisfied from the repository:
...
### Launch Wukong servers with a builtin local console
...
#### Generate LUBM_1 dataset with NT-format
...
#### Generate LUBM_1 dataset with ID-format
