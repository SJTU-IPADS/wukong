	    ...
	    while((ptr=readdir(dir))!=NULL)
	    {
	        ...
	        while(file>>subject>>predict>>object>>useless_dot){
				...
				if(object_is_vertex){	
					...
					vertex_array[id[0]].propertys.push_back(vertex_row(id[1],id[2]));
				}				
			}        
	    }
	    closedir(dir);
	    timer t2;
	    cout<<"Loading in "<<t2.diff(t1)<<" ms"<<endl;
	    cout<<"sizeof vertex_array is "<<vertex_array.size()<<endl;
	    cout<<"All propertys or predict types"<<endl;
