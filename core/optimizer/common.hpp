...
public:
    ...
    */
    ...
    void merge(int col) {
        ...
        vector<double> tytable_new;
        int row_num = get_row_num();

        unordered_map<int, int> hash2col;
...
{   
    ...
    unordered_map<ssid_t, unordered_map<ssid_t, double>> var2map;
    vector<ssid_t> path;
    ...
    void update_result(vector<double> &updated_result_table) {
        all_cost += add_cost;
