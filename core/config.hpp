...
bool global_use_statistics_cache = false;
...
static bool set_immutable_config(string cfg_name, string value)
{
	...
	} else if (cfg_name == "global_use_statistics_cache") {
		global_use_statistics_cache = atoi(value.c_str());
	}
	else {
		return false;
	}
...
void print_config(void)
{
	...
	logstream(LOG_INFO) << "global_use_statistics_cache: " 	<< global_use_statistics_cache	<< LOG_endl;
