...
public:
     ...
     * If this query is generated by generate_union_query, its PGType is UNION.
     * If this query is generated by generate_optional_query, its PGType is OPTIONAL.
    ...
    public:
        ...
        // OPTIONAL
        vector<bool> optional_matched_rows(0); // mark which rows are matched in optional block
    ...
    // this function is called by query generated by generate_optional_req
    void count_optional_new_vars(const Result &r) {
