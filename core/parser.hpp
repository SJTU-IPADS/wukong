...
private:
    ...
    void _H_simplist_transfer(const SPARQLParser &parser, SPARQLRequest &r) {
    ...
    bool _H_do_parse(istream &is, SPARQLRequest &r) {
...
public:
    ...
    /* Used in single-mode */
    bool parse(istream &is, SPARQLRequest &r) {
    ...
    bool add_type_pattern(string type, SPARQLRequest &r) {
        clear();
        r = SPARQLRequest();
